...
# TODO: Needs Review, part2 is still just raw solution with bruteforce that took 3h,
#  still haven't had time to apply rethink this (Chinese Remainder Theorem might be a solution for the inverse module)

from aocutils import lcm, read_input, timer
